...
class Brain:
    def __init__(self, StateSize, ActionSize):
        ...
        if(os.path.exists("./DDQN_with_Static_Obstacles_new.h5")):
            self.model.load_weights("DDQN_with_Static_Obstacles_new.h5")
            self.model_.load_weights("DDQN_with_Static_Obstacles_new.h5")
            print("loaded DDQN_with_Static_Obstacles_new.h5 successfully") 
        else:
            print("no save file")
...
try:
    while True :
        ...
        agent.brain.model.save("DDQN_with_Static_Obstacles_new.h5")
